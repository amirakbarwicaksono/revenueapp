...
// 	}
// 	if currency := c.Query("SalesCurrency"); currency != "" {
// 		currencyList := strings.Split(currency, ",")
// 		if len(currencyList) == 0 {
// 			log.Printf("Empty SalesCurrency list")
// 			c.JSON(http.StatusBadRequest, gin.H{
// 				"success": false,
// 				"message": "Invalid SalesCurrency value",
// 			})
// 			return
// 		}
// 		filter["SalesCurrency"] = bson.M{"$in": currencyList}
// 	}
